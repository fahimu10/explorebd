        ...
        <div class="container form-content">
            <div class="row h-100">
                <div class="col-md-6 signup-left d-flex flex-column align-items-center justify-content-center pr-5">
                    ...
                    <form class="w-100" action="signup_code.php" method="post">
                        <div class="row w-100">
                            <div class="col-md-12">
                        ...
                        <div class="row w-100">
                            <div class="col-md-12">
                                <input class="w-100 input-field" type="email" name="user-email" class="input-box" placeholder="Email" required>
                            </div>
                        </div>
                        <div class="row w-100">
                            <div class="col-md-12">
                    ...
                    <div class="row w-100 my-1">
                        <div class="col-md-12 w-100 text-center">
                            <p>Already have a account <strong><a href="login.php">Log In</a></strong></p>
                        </div>
                    </div>
